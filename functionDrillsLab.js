...
const nameGreeting = nameCheck('Jack')
nameGreeting
...
//CODE HERE
const uppercase = upper => console.log(upper.toUpperCase())

uppercase('this should all be uppercase')
...
//CODE HERE
const buyfrog = (gold) => console.log(`You can buy ${gold / 3} chocolate frogs with ${gold} gold at 3 gold each.`)
let totalFrogs = buyfrog(19)
////////////////// PROBLEM 13 ////////////////////
/*
...
//CODE HERE
const buyfrog2 = (gold) => console.log(`You can buy ${Math.floor(gold / 3)} chocolate frogs with ${gold} gold at 3 gold each.`)
let totalFrogs2 = buyfrog2(19)
////////////////// PROBLEM 14 ////////////////////
...
let arrayIsAscending = funcArr(sampleArray)
...
let bathroomScope = ['ruberDuck', 'sailorDuck']
